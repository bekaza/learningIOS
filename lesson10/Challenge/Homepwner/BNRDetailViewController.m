...
@property (weak, nonatomic) IBOutlet UIButton *btn_changeDate;
...
- (IBAction)btn_changeDate:(id)sender
{
    //NSLog(@"Change Date");
    
    BNRDateViewController * changeDateViewController = [[BNRDateViewController alloc] init];
